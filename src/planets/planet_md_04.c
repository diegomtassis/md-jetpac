...
static void createPlatforms(Planet planet[static 1]) {
	...
	planet->platforms[1] = LOC_createPlatform(2, 22, 4);
	planet->platforms[2] = LOC_createPlatform(2, 19, 4);
	planet->platforms[3] = LOC_createPlatform(2, 16, 4);
	planet->platforms[4] = LOC_createPlatform(2, 13, 4);

	planet->platforms[5] = LOC_createPlatform(10, 22, 4);
	planet->platforms[6] = LOC_createPlatform(10, 19, 4);
	planet->platforms[7] = LOC_createPlatform(10, 16, 4);
	planet->platforms[8] = LOC_createPlatform(10, 13, 4);
	planet->platforms[9] = LOC_createPlatform(10, 10, 4);

	planet->platforms[10] = LOC_createPlatform(18, 22, 4);
	planet->platforms[11] = LOC_createPlatform(18, 19, 4);
	planet->platforms[12] = LOC_createPlatform(18, 16, 4);
	planet->platforms[13] = LOC_createPlatform(18, 13, 4);
	planet->platforms[14] = LOC_createPlatform(18, 10, 4);
	planet->platforms[15] = LOC_createPlatform(26, 22, 4);
	planet->platforms[16] = LOC_createPlatform(26, 19, 4);
	planet->platforms[17] = LOC_createPlatform(26, 16, 4);
	planet->platforms[18] = LOC_createPlatform(26, 13, 4);
}
